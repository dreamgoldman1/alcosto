...
To use these stylesheets, rename the files and al_costo with the name of your theme.
...
al_costo-alpha-default-narrow.css  
...
al_costo-alpha-default-normal.css
...
al_costo-alpha-default-wide.css
